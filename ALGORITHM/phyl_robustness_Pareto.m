function [PvalueRatio] = phyl_robustness_Pareto(idx_data,nametable,namefolder,analysis_type)
%%
    ...
    parfor thr = 1:length(thr_ALL)        
        % Generate category names based on the number of unique groups, such as: 'Category1', 'Category2', ...
