...
%% PANEL A - Plot the phylogenetic tree as a function of the milion of years.
    ...
    filename = [pwd,'/Figures/Figure 5/phyl_tree_ALL.pdf']; exportgraphics(gcf,filename,'ContentType','vector');    
...
filename = [pwd,'/Figures/Figure 5/pvals_phyl_dependence.pdf']; exportgraphics(gcf,filename,'ContentType','vector');  
end