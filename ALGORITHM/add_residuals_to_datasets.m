...
%% We added the residuals to each dataset
    ...
    table_selected_dataset.namefolder        = [pwd,'/Figures/Figures_2_3_4/',char(table_selected_dataset.nametable),'/']; 
    table_selected_dataset.cont_enrich_folder  = [pwd,'/Figures/Figures_2_3_4/',char(table_selected_dataset.nametable),'/Cont_enrich_',char(table_selected_dataset.nametable),'/']; 
    table_selected_dataset.disc_enrich_folder  = [pwd,'/Figures/Figures_2_3_4/',char(table_selected_dataset.nametable),'/Disc_enrich_',char(table_selected_dataset.nametable),'/'];
    table_selected_dataset.outputs_folder      = [pwd,'/Figures/outputs/'];
