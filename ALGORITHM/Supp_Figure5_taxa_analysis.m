...
%     filename = [pwd,'/Figures/Figure 6/n_groups_evolutionary_time.pdf']; exportgraphics(gcf,filename,'ContentType','vector');  
...
%         % Uncomment the line below to save on the Drive
%     filename = [pwd,'/Figures/Figure 6/marginal_distributions_clusters.pdf']; exportgraphics(gcf,filename,'ContentType','vector');  
...
%         % Uncomment the line below to save on the Drive
%     filename = [pwd,'/Figures/Figure 6/pvals_phyl_dependence_clusters.pdf']; exportgraphics(gcf,filename,'ContentType','vector');  
