...
% % % %     figure; scatter(data_conv_plot(:,1),data_conv_plot(:,2), 4,'k','filled'); hold on; convhull_plot = plot(data_conv_plot(k_hull,1), data_conv_plot(k_hull,2)); 
...
% % % %     idx_data = 9; % According to the files included in the DATA folder, Tetrapods correspond to idx_data = 9
% % % %     name_class = table_spereto(idx_data).name_class;
% % % %     filename = [namefolder,name_class,' Pareto_Front_tratio_randomized.eps']; 
