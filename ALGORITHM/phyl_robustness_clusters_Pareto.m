...
%     centroid_clusters_thr = cell(1,length(uniqueVectors)-52);
%     PvalueRatio = cell(1,length(uniqueVectors)-52);
%     parfor thr = 52:length(uniqueVectors)
...
%         figure;scatter(centroid_clusters(:,1),centroid_clusters(:,2),'k','filled')
