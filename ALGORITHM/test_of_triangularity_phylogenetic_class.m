...
%%%%% Extract the same number of species for each of the selcted classes and store both the Datapoints and their phylogenetic class for further analyses
...
findArchetypes(nametable, namefolder, DataPoints_selected, phylogenetic_class_individuals_selected, analysis_type, name_class, thr)