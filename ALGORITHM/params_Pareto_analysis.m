...
params_Pareto.maxRuns = 200; % how many bootstrapping iterations should be performed to estimate the errors on the archetypes
params_Pareto.numIter = 20; % the number of iterations for the algorithm to find a minimal bounding simplex
