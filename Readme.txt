...
1) ALGORITHM: This folder contains all the necessary customized code and is based on the ParTI toolbox (https://www.weizmann.ac.il/mcb/UriAlon/download/ParTI).
