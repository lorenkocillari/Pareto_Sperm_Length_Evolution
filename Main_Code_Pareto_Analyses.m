...
clear all; addpath(genpath('ALGORITHM/')); % Add the path of the folder containing the rest of the code
auxiliary_spereto; % We define here the parameters of the Pareto analyses.
